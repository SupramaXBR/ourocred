...
<body>
   ...
   <div class="container">
      ...
      <div class="alert alert-primary" role="alert">
         <div class="center">CURIOSIDADES SOBRE O OURO</div>
      </div>
   </div>
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justify">
            <p class="text-justify">O ouro é um elemento químico de número atômico 79 que está situado no grupo 11 da tabela periódica, e de massa atômica 197 u. Na natureza, o ouro é produzido a partir da colisão de duas estrelas de nêutrons.</p>

            <p class="text-justify">Na natureza, o ouro é produzido a partir da colisão de duas estrelas de nêutrons.</p>

            <p><b>Massa atômica:</b> 196,96657 u</p>
            <p><b>Série química:</b> Metal, Metal de transição</p>
            <p><b>Número atômico:</b> 79</p>
            <p><b>Ponto de fusão:</b> 1064 °C</p>
         </div>

         <div class="col-lg-4 col-md-12 d-none d-lg-block">
            <img src="imagens/quimicaouro.png" class="img-fluid rounded" alt="Ouro">
         </div>
      </div>
   </div>
   <br>
