...
<link rel="stylesheet" href="css/ouro.css">
<?php
...
<body>
   ...
   <div class="container">
      ...
      <div class="alert alert-primary" role="alert">
         <div class="center">ORIGEM DO OURO</div>
      </div>
   </div>
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            <p>O ouro comercializado pela OuroCred é adquirido tanto no mercado de balcão quanto no mercado primário, sendo extraído de áreas de mineração no Brasil e proveniente de Permissões de Lavra Garimpeira (PLG) devidamente autorizadas pela Agência Nacional de Mineração (ANM).</p>

            <p>A OuroCred é uma instituição financeira e distribuidora de títulos e valores mobiliários (DTVM), atuando conforme as normas do Conselho Monetário Nacional (CMN) e autorizada pelo Banco Central (BACEN 27930). Além disso, está registrada na Comissão de Valores Mobiliários (CVM), é associada à Associação Brasileira de Câmbio (ABRACAM) e possui certificações internacionais da Americas Gold Manufacturers Association (AMAGOLD), além de certificados de qualidade ISO 45001, ISO 9001 e ISO 14001 pela ABS Quality Evaluations (ABS QE). A empresa também é certificada pela iniciativa "Plante Árvore" do Instituto Brasileiro de Florestas (IBF) e foi reconhecida como um "Great Place to Work" (GPTW).</p>

            <p>Parte dos colaboradores e parceiros da OuroCred possuem certificações da ABRACAM (ABT1 e ABT2) e da ANBIMA (CPA-10 e CPA-20).</p>
         </div>

         <div class="col-lg-4 col-md-12 d-none d-lg-block text-center">
            <img src="imagens/pepita.png" alt="Imagem Circular" class="img-fluid rounded-circle">
         </div>
      </div>
   </div>
   <br>
