...
$qtddia = retornarQtddiaClassic('1');
$perdsc = retornarPerdscClassic('1');
?>
   ...
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            <h2><strong>Plano Classic OuroCred</strong></h2>

            <p>O plano <strong>Classic</strong> foi desenvolvido para investidores que buscam retorno garantido em curto prazo. Neste plano, você investe em ouro digital com a segurança de recompra após <?php echo $qtddia; ?> dias, assegurando um retorno de <?php echo $perdsc; ?>% acima do valor de mercado na data da venda.</p>

            <p>Ideal para quem deseja uma valorização rápida e confiável, o plano Classic oferece uma forma prática de aproveitar o potencial de valorização do ouro sem comprometer o capital por um longo período.</p>

            <p>Invista com a OuroCred no plano Classic e tenha a certeza de um retorno seguro e eficiente, perfeito para suas necessidades financeiras imediatas.</p>
