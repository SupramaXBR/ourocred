   ...
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            <h2><strong>Plano Simple OuroCred</strong></h2>

            <p>O plano <strong>Simple</strong> é a opção ideal para quem busca flexibilidade em seus investimentos em ouro digital.</p>

            <p>Neste plano, você realiza transações de compra e venda conforme sua necessidade, sem períodos definidos para recompra, garantindo liberdade total para gerir seu investimento.</p>

            <p>A OuroCred realiza a compra do seu ouro digital pelo valor de mercado do ouro, descontando apenas uma taxa fixa de R$ 50,00 por grama, garantindo transparência total nas suas operações.</p>
