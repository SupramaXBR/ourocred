...
<body>
   ...
   <div class="container">
      ...
      <div class="alert alert-primary" role="alert">
         <div class="center">POR QUE INVESTIR EM OURO?</div>
      </div>
   </div>
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            <p>Ao longo da história humana, o ouro desempenhou um papel quase mítico nas relações de poder entre os povos.</p>

            <p>No caso do metal dourado mais cobiçado do mundo, essa valoração se deu antes mesmo da criação da moeda como meio de troca: os astrônomos da Antiguidade ensinavam ao povo a existência de uma íntima conexão entre ouro e Sol, prata e Lua. Essa ligação ajudou a desenvolver a crença no poder mágico desses metais.</p>

            <p>De 1875 à metade do século XX, o sistema monetário mundial foi integrado pelo ouro e usado como referência econômica internacional (“padrão-ouro”).</p>

            <p>Nesse modelo, estipulava-se a obrigatoriedade de cada país manter parte relevante de suas reservas internacionais na forma de ouro, e eram essas reservas que definiam as políticas de comércio exterior de cada nação.</p>

            <p>Engana-se quem achava que a fixação do dólar como referência mundial (no fim do século XX) tiraria o prestígio do ouro. Em 2018, por exemplo, os Bancos Centrais pelo mundo compraram mais ouro do que em todos os anos anteriores, desde 1971.</p>
         </div>

         <div class="col-lg-4 col-md-12 d-none d-lg-block text-center">
            <img src="imagens/grafico.png" alt="Gráfico Ouro" class="img-fluid rounded-circle">
         </div>
      </div>
   </div>
   <br>
