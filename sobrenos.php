   ...
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            ...
            <p>Fundada em 2020, a <strong>OuroCred DTVM LTDA</strong> é uma distribuidora de títulos e valores mobiliários (DTVM) especializada na venda de ouro digital. Com sede em Várzea Grande, Mato Grosso, nossa missão é tornar o mercado de ouro acessível e transparente para todos que desejam investir de forma segura e com perspectiva de valorização.</p>

            <p>Na OuroCred, oferecemos aos nossos clientes a oportunidade de adquirir ouro digital com a garantia de recompra futura. Nossa abordagem visa proporcionar uma experiência de investimento confiável, onde o cliente compra ouro digital, acompanha a valorização e pode vendê-lo no momento mais oportuno para obter lucro.</p>

            <p>Com um capital social de R$ 100.000.000,00 e equipe dedicada, atuamos com seriedade e compromisso, prezando pela segurança de cada transação e pelo crescimento do patrimônio de nossos clientes. Acreditamos no potencial do ouro como ativo de proteção e valorização ao longo do tempo, e trabalhamos continuamente para oferecer soluções eficientes e vantajosas para quem deseja investir.</p>

            <p><strong>Endereço</strong><br>
               Avenida Couto Magalhães (Lot Centro), 2277<br>
         ...
         <div class="col-lg-4 col-md-12 d-none d-lg-block text-center">
            ...
            <img src="imagens/logo.png" alt="Logo OuroCred" class="img-fluid rounded-circle">
