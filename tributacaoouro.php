...
<body>
   ...
   <div class="container">
      ...
      <div class="alert alert-primary" role="alert">
         <div class="center">TRIBUTAÇÃO DO OURO</div>
      </div>
   </div>
   <br>
   <div class="container my-5">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-12 text-justificado">
            <p>O investimento em Ouro Ativo Financeiro é tratado como aplicação em Renda Variável, sendo regulamentado pela Lei nº 11.033, de 21 de dezembro de 2004, e regulamentado pela Instrução Normativa RFB nº 1.022, de 5 de abril de 2010.</p>
            ...
            <p>No caso do valor das alienações dos ativos financeiros de renda variável em conjunto superar os R$ 20.000,00 (vinte mil reais) dentro do mesmo mês, aplica-se a alíquota de 15% (quinze por cento) sobre os ganhos de capital obtidos, sendo o recolhimento efetuado até o último dia útil do mês subsequente, via carne leão. Nas operações de Day-trade (compra e venda no mesmo dia), a alíquota é de 20% sobre o ganho.</p>

            <p>O ICMS não é aplicado na comercialização de ouro ativo financeiro.</p>
         </div>

         <div class="col-lg-4 col-md-12 d-none d-lg-block text-center">
            <img src="imagens/tributos.png" alt="Tributação Ouro" class="img-fluid rounded-circle">
         </div>
      </div>
   </div>
   <br>
